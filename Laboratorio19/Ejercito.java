...
public class Ejercito{
    ...
    public void asignarEstadisticas(String reino){
        if(reino.equals("Inglaterra")){
            EspadachinReal obj = new EspadachinReal();
            this.ejercito.add(obj);
        }else if(reino.equals("Francia")){
            CaballeroFranco obj = new CaballeroFranco();
            this.ejercito.add(obj);
        }else if(reino.equals("Castilla-Aragón")){
            EspadachinConquistador obj = new EspadachinConquistador();
            this.ejercito.add(obj);
        }else if(reino.equals("Moros")){
            CaballeroMoro obj = new CaballeroMoro();
            this.ejercito.add(obj);
        }else{
            EspadachinTeutonico obj = new EspadachinTeutonico();
            this.ejercito.add(obj);
        }
